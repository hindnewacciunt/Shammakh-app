...
import 'package:flutter_shammakh_ecommerce/view/basewidget/product_widget.dart';
import 'package:flutter_shammakh_ecommerce/view/basewidget/title_row.dart';
import 'package:flutter_shammakh_ecommerce/view/screen/product/brand_and_category_product_screen.dart';
                ...
                itemBuilder: (ctx, index) {
                  return Column(
                    ...
                    children: [
                      isHomePage
                          ? Padding(
                              padding: EdgeInsets.fromLTRB(5, Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_SMALL, Dimensions.PADDING_SIZE_SMALL),
