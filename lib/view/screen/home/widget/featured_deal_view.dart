  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<FeaturedDealProvider>(
      builder: (context, featuredDealProvider, child) {
        return Provider.of<FeaturedDealProvider>(context).featuredDealList.length != 0 ?
        ListView.builder(
          padding: EdgeInsets.all(0),
          scrollDirection: Axis.vertical,
          physics: NeverScrollableScrollPhysics(),
          itemCount: featuredDealProvider.featuredDealList.length >4 && isHomePage ?
          4 : featuredDealProvider.featuredDealList.length,
