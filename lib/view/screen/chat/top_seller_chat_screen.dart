...
import 'package:flutter_shammakh_ecommerce/data/model/body/MessageBody.dart';
import 'package:flutter_shammakh_ecommerce/data/model/response/top_seller_model.dart';
import 'package:flutter_shammakh_ecommerce/data/model/response/chat_model.dart';
...
import 'package:flutter_shammakh_ecommerce/view/screen/chat/widget/message_bubble.dart';
                    ...
                    InkWell(
                      onTap: () {
                        if(Provider.of<ChatProvider>(context, listen: false).isSendButtonActive){
                          MessageBody messageBody = MessageBody( shopId: topSeller.id.toString(), message: _controller.text);
