...
import 'package:flutter_shammakh_ecommerce/data/model/response/support_ticket_model.dart';
...
import 'package:flutter_shammakh_ecommerce/view/basewidget/custom_expanded_app_bar.dart';
import 'package:flutter_shammakh_ecommerce/view/basewidget/no_internet_screen.dart';
import 'package:flutter_shammakh_ecommerce/view/screen/support/support_conversation_screen.dart';
            ...
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => SupportConversationScreen(
                        ...
                        Row(children: [
                          ...
                          TextButton(
                            ...
                            style: TextButton.styleFrom(
                              backgroundColor: supportTicketList[index].status == 'open' ? ColorResources.getGreen(context) : Theme.of(context).primaryColor,
                            ),
                            child: Text(
                              supportTicketList[index].status == 'pending' ? getTranslated('pending', context) : getTranslated('solved', context),
