...
import 'package:flutter_shammakh_ecommerce/view/basewidget/custom_loader.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return CustomExpandedAppBar(
      ...
      child: Column(children: [
        ...
        //     Text(
        //       'Place date: ${DateConverter.localDateToIsoStringAMPM(DateTime.parse(supportTicketModel.createdAt))}',
        ...
        //         ),
        //         child: Text(
        //           supportTicketModel.status == 0 ? getTranslated('pending', context) : getTranslated('solved', context),
