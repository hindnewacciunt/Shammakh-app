...
import 'package:flutter_shammakh_ecommerce/data/model/response/order_details.dart';
import 'package:flutter_shammakh_ecommerce/data/model/response/product_model.dart';
import 'package:flutter_shammakh_ecommerce/helper/price_converter.dart';
import 'package:flutter_shammakh_ecommerce/localization/language_constrants.dart';
import 'package:flutter_shammakh_ecommerce/provider/order_provider.dart';
import 'package:flutter_shammakh_ecommerce/provider/splash_provider.dart';
import 'package:flutter_shammakh_ecommerce/utill/app_constants.dart';
...
import 'package:flutter_shammakh_ecommerce/view/basewidget/custom_app_bar.dart';
import 'package:flutter_shammakh_ecommerce/view/basewidget/image_diaglog.dart';
                        ...
                        child: Column(mainAxisSize: MainAxisSize.min,
                            ...
                            children: [
                              ...
                              Text('${getTranslated('refund_id', context)}'+
                                ...
                                style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.getTextTitle(context)),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          widget.orderDetailsModel.discount>0?Container(
                                            height: 20,
                              ...
                              Consumer<OrderProvider>(
                                  builder: (context, refund,_) {
                                    return refund.refundResultModel!=null && refund.refundResultModel.refundRequest != null ? Padding(
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            ...
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  ...
                                                  TextSpan(text: PriceConverter.convertPrice(context, refund.refundInfoModel.refund.subtotal), style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ),
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  ...
                                                  TextSpan(text: PriceConverter.convertPrice(context, refund.refundInfoModel.refund.couponDiscount), style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ),
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  ...
                                                  TextSpan(text: PriceConverter.convertPrice(context, refund.refundInfoModel.refund.refundAmount), style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ),
                                            Divider(),
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  TextSpan(text: getTranslated('refund_status', context), style: TextStyle(fontWeight: FontWeight.bold)),
                                                  TextSpan(text: refund.refundResultModel.refundRequest[0].status, style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ),
                                            ...
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  TextSpan(text: getTranslated('approved_note', context), style: TextStyle(fontWeight: FontWeight.bold)),
                                                  TextSpan(text: ' : ', style: TextStyle(fontWeight: FontWeight.w200)),
                                                  TextSpan(text: refund.refundResultModel.refundRequest[0].approvedNote, style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ):SizedBox(),
                                            //Text('${getTranslated('approved_note', context)} : ${refund.refundResultModel[0].approvedNote}', style: titilliumSemiBold.copyWith(color: ColorResources.getHint(context), fontSize: 12)):SizedBox(),
                                            refund.refundResultModel.refundRequest[0].rejectedNote != null?
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  TextSpan(text: getTranslated('rejected_note', context), style: TextStyle(fontWeight: FontWeight.bold)),
                                                  TextSpan(text: ' : ', style: TextStyle(fontWeight: FontWeight.w200)),
                                                  TextSpan(text: refund.refundResultModel.refundRequest[0].rejectedNote, style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ):SizedBox(),
                                            //Text('${getTranslated('rejected_note', context)} : ${refund.refundResultModel[0].rejectedNote}', style: titilliumSemiBold.copyWith(color: ColorResources.getHint(context), fontSize: 12)):SizedBox(),
                                            //refund.refundResultModel.refundRequest[0].changeBy != null?
                                           // Text('${getTranslated('updated_by', context)} : ${refund.refundResultModel.refundRequest[0].changeBy}', style: titilliumSemiBold.copyWith(color: ColorResources.getHint(context), fontSize: 12)):SizedBox(),
                                            refund.refundResultModel.refundRequest[0].paymentInfo != null?
                                            Text('${getTranslated('payment_info', context)} : ${refund.refundResultModel.refundRequest[0].paymentInfo}', style: titilliumSemiBold.copyWith(color: ColorResources.getHint(context), fontSize: 12)):SizedBox(),

                                            Divider(),
                                            RichText(
                                              text: TextSpan(text: '', style: DefaultTextStyle.of(context).style,
                                                children: <TextSpan>[
                                                  TextSpan(text:  getTranslated('refund_reason', context), style: TextStyle(fontWeight: FontWeight.w700)),
                                                  TextSpan(text: refund.refundResultModel.refundRequest[0].refundReason, style: TextStyle(fontWeight: FontWeight.w200)),
                                                ],
                                              ),
                                            ),

                                            refund.refundResultModel.refundRequest[0].images != null && refund.refundResultModel.refundRequest[0].images.length>0?
                                                Text(getTranslated('attachment', context),style: TextStyle(decoration: TextDecoration.underline),):SizedBox(),
                                            refund.refundResultModel.refundRequest[0].images != null && refund.refundResultModel.refundRequest[0].images.length>0?
                                                ...
                                                itemBuilder: (BuildContext context, index){
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Stack(
                                                      children: [
                                                        InkWell(
                                                          onTap: () => showDialog(context: context, builder: (ctx)  =>  ImageDialog(imageUrl:'${AppConstants.BASE_URL}/storage/app/public/refund/${refund.refundResultModel.refundRequest[0].images[index]}'), ),
                                                          child: Container(width: 100, height: 100,
                                                            child: ClipRRect(
                                                              ...
                                                              child: FadeInImage.assetNetwork(placeholder: Images.placeholder,
                                                                image: '${AppConstants.BASE_URL}/storage/app/public/refund/${refund.refundResultModel.refundRequest[0].images[index]}',
