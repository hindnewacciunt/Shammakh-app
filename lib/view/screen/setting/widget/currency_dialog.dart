          ...
          Expanded(child: TextButton(
            onPressed: () {
              if(isCurrency) {
                ...
                Provider.of<TopSellerProvider>(context, listen: false).getTopSellerList(true, context);
                Provider.of<BrandProvider>(context, listen: false).getBrandList(true, context);
